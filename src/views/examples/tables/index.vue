...
<template>
  <div class="advanced-table-demo">
    ...
    <!-- 搜索区域 -->
    <ArtSearchBar v-model:filter="searchFormState" :items="searchItems" :is-expand="false" :show-expand="true"
    ...
    <ElCard class="art-table-card" shadow="never" style="margin-top: 0">
      ...
      <ArtTableHeader v-model:columns="columnChecks" @refresh="handleRefresh"
        ...
        <template #left>
          <div class="toolbar-left">
            ...
            <!-- 导出导入功能 -->
            <ArtExcelExport :data="tableData as any" :columns="exportColumns as any" filename="用户数据" :auto-index="true"
      ...
      <!-- 
       ...
       -->
      <ArtTable ref="tableRef" :loading="isLoading" :pagination="paginationState" :data="tableData" :columns="columns"
        :table-config="{
          ...
          sumText: '合计'
        }" :layout="{ marginTop: 16, showIndex: false }" @row:selection-change="handleSelectionChange"
        @row:click="handleRowClick" @row:dblclick="handleRowDblclick" @row:contextmenu="handleRowContextmenu"
        @cell:click="handleCellClick" @cell:dblclick="handleCellDblclick" @header:click="handleHeaderClick"
        @sort:change="handleSortChange" @pagination:size-change="onPageSizeChange"
    ...
    <ElCard class="advanced-features-card" shadow="never">
      ...
      <div class="feature-demo-section">
        ...
        <div class="demo-group">
          <h5>⚙️ 表格配置演示</h5>
          <div class="demo-buttons">
            <ElSwitch v-model="tableConfig.showSummary" active-text="显示合计行" style="margin-left: 10px" />
            <ElSwitch v-model="tableConfig.fixedHeight" active-text="固定高度 (500px)" inactive-text="自适应高度"
